...
// Returns the current inner width and updates on resize. Resize events fire
// rapidly during a drag; we coalesce them into one update per animation frame
// and bail out when the width is unchanged, so a resize doesn't re-render the
// (large) app tree on every pixel.
